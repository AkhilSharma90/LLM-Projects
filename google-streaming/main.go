...
func main() {
	...
	content := []llms.MessageContent{
		...
		llms.TextParts(llms.ChatMessageTypeHuman, "What would be a good company name for a comapny that produces Go-backed LLM tools? give concise and short answer."),
	}
